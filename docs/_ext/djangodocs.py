"""
Sphinx plugins for Django documentation - from django.docs._ext.djangodocs
"""
import json
import os
import re
...
def setup(app):
    ...
    # app.add_direc2tive('versionchanged', VersionDirective)
...
def visit_console_html(self, node):
    ...
    if (
        self.builder.name in ("djangohtml", "json")
